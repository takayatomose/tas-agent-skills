...
1. **Acceptance Testing** — Systematically verify each Acceptance Criterion (AC) defined in the requirements phase. Use factories or mocks to generate the specific data needed for the story's scenarios.
