...
1. **Gate In (MANDATORY)** — Run `tas-agent memory search "<testing context or target module>"` to retrieve past test patterns and common failure modes.
...
7. **Gate Out (MANDATORY)** — Run `tas-agent memory store "Testing Details: <Feature Name>" "<Summary of Test Scenarios, Coverage, and Mocking Strategies>"` to capture testing knowledge.
